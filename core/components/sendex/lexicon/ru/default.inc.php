...
$_lang['sendex_newsletter_remove_confirm'] = 'Вы уверены, что хотите удалить выбранную подписку?';
...
$_lang['sendex_subscriber_remove_confirm'] = 'Вы действительно хотите отписать выбраного пользователя от этой подписки?';
